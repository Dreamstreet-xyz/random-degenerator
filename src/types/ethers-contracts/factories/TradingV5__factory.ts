...
import type { TradingV5, TradingV5Interface } from "../TradingV5";
...
export class TradingV5__factory {
  static readonly abi = _abi;
  static createInterface(): TradingV5Interface {
    return new utils.Interface(_abi) as TradingV5Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TradingV5 {
    return new Contract(address, _abi, signerOrProvider) as TradingV5;
  }
}
