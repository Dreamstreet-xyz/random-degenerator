...
import type { TradingV6, TradingV6Interface } from "../TradingV6";
...
export class TradingV6__factory {
  static readonly abi = _abi;
  static createInterface(): TradingV6Interface {
    return new utils.Interface(_abi) as TradingV6Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TradingV6 {
    return new Contract(address, _abi, signerOrProvider) as TradingV6;
  }
}
